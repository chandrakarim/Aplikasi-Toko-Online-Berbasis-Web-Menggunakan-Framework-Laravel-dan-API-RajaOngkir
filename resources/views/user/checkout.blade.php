              ...
              <div class="col-md-12">
                ...
                <div class="p-3 p-lg-5 border">
                  ...
                  <div class="form-group">
                    ...
                    <textarea required name="pesan" class="form-control"></textarea>
                  </div>
                  <div class="form-group">
                    <label for="">No telepon yang bisa dihubungi</label>
                    <input required type="number" name="no_hp" id="" class="form-control">
                  </div>
                  ...
                  <label for="">Pilih Metode Pembayaran</label>
                    <select required name="metode_pembayaran" id="" class="form-control">
