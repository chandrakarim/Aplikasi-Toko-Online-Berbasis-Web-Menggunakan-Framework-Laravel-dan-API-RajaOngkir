...
Route::group(['middleware' => ['auth','checkRole:customer']],function(){
    ...
    Route::post('/cek-ongkir','user\KeranjangController@cekOngkir')
    ->name('cek.ongkir');
    Route::post('/set-ongkir-session','user\KeranjangController@setOngkirSession')
    ->name('set.ongkir.session');
